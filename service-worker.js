...
const VERSION = 'cpla-quiz-v17-20260427-keyword-unify-kw-fullsubject-admin-promote-pending-grade-seo-race-fix-free-block-admin-init-brand-fix-expl-enhance';
const CORE = [
  './',
  './index.html',
  './years.html',
